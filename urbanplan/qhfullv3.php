...
<head>
    ...
    <script type="text/javascript">
		...
		function addControl(){
			...
			//add select opacity value
		    gmap.addControl({
		        position: 'right_top',
		        content: 'Opacity <select onchange="changeopacitymap(this.value)">' +
		...
		function changeopacitymap(value){
			customMapType.setOpacity(parseFloat(value));		
		}
